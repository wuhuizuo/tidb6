...
func TestFailNewSession(t *testing.T) {
	...
	func() {
		...
		defer func() {
			...
			require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/util/closeClient"))
		}()
		require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/util/closeClient", `return(true)`))
	...
	func() {
		...
		defer func() {
			...
			require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/util/closeGrpc"))
		}()
		require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/util/closeGrpc", `return(true)`))
