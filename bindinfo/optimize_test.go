...
func TestOptimizeOnlyOnce(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/planner/checkOptimizeCountOne", "return(\"select * from t\")"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/planner/checkOptimizeCountOne"))
	}()
