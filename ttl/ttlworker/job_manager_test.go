...
func TestLockNewTable(t *testing.T) {
	...
	failpoint.Enable("github.com/wuhuizuo/tidb6/ttl/ttlworker/set-job-uuid", `return("test-job-id")`)
	defer failpoint.Disable("github.com/wuhuizuo/tidb6/ttl/ttlworker/set-job-uuid")
