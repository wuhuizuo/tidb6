...
import (
	...
	dbsession "github.com/wuhuizuo/tidb6/session"
	...
	"github.com/wuhuizuo/tidb6/ttl/cache"
	"github.com/wuhuizuo/tidb6/ttl/session"
...
func TestTTLAutoAnalyze(t *testing.T) {
	failpoint.Enable("github.com/wuhuizuo/tidb6/ttl/ttlworker/update-info-schema-cache-interval", fmt.Sprintf("return(%d)", time.Second))
	failpoint.Enable("github.com/wuhuizuo/tidb6/ttl/ttlworker/update-status-table-cache-interval", fmt.Sprintf("return(%d)", time.Second))
	failpoint.Enable("github.com/wuhuizuo/tidb6/ttl/ttlworker/resize-workers-interval", fmt.Sprintf("return(%d)", time.Second))
