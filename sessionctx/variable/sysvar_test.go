...
func TestTimeZone(t *testing.T) {
	...
	// See: https://github.com/wuhuizuo/tidb6/issues/8087
...
func TestTiDBServerMemoryLimit2(t *testing.T) {
	...
	require.Nil(t, failpoint.Enable("github.com/wuhuizuo/tidb6/util/memory/GetMemTotalError", `return(true)`))
	require.Error(t, mock.SetGlobalSysVar(context.Background(), TiDBServerMemoryLimit, "75%"))
	require.Nil(t, failpoint.Disable("github.com/wuhuizuo/tidb6/util/memory/GetMemTotalError"))
