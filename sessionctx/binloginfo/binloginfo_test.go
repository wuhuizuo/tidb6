...
func createBinlogSuite(t *testing.T) (s *binlogSuite) {
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/store/driver/txn/mockSyncBinlogCommit", `return(true)`))
	...
	t.Cleanup(func() {
		...
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/driver/txn/mockSyncBinlogCommit"))
	})
