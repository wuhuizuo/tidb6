...
// It is used for the column field type (`github.com/wuhuizuo/tidb6/parser/types.FieldType.Tp`).
type fieldTp struct {
	value byte
}

// FieldTp is used for the column field type (`github.com/wuhuizuo/tidb6/parser/types.FieldType.Tp`).
...
func (a fieldTp) Compare(other Lattice) (int, error) {
	...
	// maybe we can ref https://github.com/wuhuizuo/tidb6/blob/38f4d869d86c3b274e7d1998a52243a30b125c80/types/field_type.go#L325 later.
