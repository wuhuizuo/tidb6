...
func TestBeginSleepABA(t *testing.T) {
	...
	if !lastReadFromCache(tk1) {
		...
		// It is a bug, ref https://github.com/wuhuizuo/tidb6/issues/36838
...
func TestRenewLeaseABAFailPoint(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/table/tables/mockRenewLeaseABA1", `return`))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/table/tables/mockRenewLeaseABA2", `return`))
	tk.MustQuery("select * from t_lease").Check(testkit.Rows("1 1"))
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/table/tables/mockRenewLeaseABA1"))
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/table/tables/mockRenewLeaseABA2"))
