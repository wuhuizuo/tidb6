...
- Discussion PR: https://github.com/wuhuizuo/tidb6/pull/28482
- Tracking Issue: https://github.com/wuhuizuo/tidb6/issues/28481
...
1. Support for Socket Authentication (`auth_socket`) [PR in Review](https://github.com/wuhuizuo/tidb6/pull/27561)
2. Stale socket files are automatically cleaned up on server start [PR Merged](https://github.com/wuhuizuo/tidb6/pull/27886)
3. TiDB listens on both TCP **and** unix socket by default [PR in Review](https://github.com/wuhuizuo/tidb6/pull/28486)
4. Auth plugin can be changed with ALTER/CREATE [PR Draft](https://github.com/wuhuizuo/tidb6/pull/28468)
