...
The most common preparations for writing and submitting a design document for now is [creating an issue for discussion](https://github.com/wuhuizuo/tidb6/issues/new/choose), which is going to be converted into a tracking issue of the design implementation.
...
4. If accepted, [create a tracking issue](https://github.com/wuhuizuo/tidb6/issues/new/choose) for the design document or convert one from a previous discuss issue. The tracking issue basically tracks subtasks and progress. And refer the tracking issue in the design document replacing placeholder in the template.
...
- Its tracking issue: https://github.com/wuhuizuo/tidb6/issues/18032
- Its pull request: https://github.com/wuhuizuo/tidb6/pull/18982
- Its design document: https://github.com/wuhuizuo/tidb6/blob/master/docs/design/2020-08-04-global-index.md
