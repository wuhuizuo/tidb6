...
func testSortInDisk(t *testing.T, removeDir bool) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/testSortedRowContainerSpill", "return(true)"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/testSortedRowContainerSpill"))
	}()
...
func TestIssue16696(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/testSortedRowContainerSpill", "return(true)"))
	defer require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/testSortedRowContainerSpill"))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/testRowContainerSpill", "return(true)"))
	defer require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/testRowContainerSpill"))
