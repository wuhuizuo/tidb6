...
// https://github.com/wuhuizuo/tidb6/issues/23314
...
func TestRandomPanicConsume(t *testing.T) {
	...
	fpName := "github.com/wuhuizuo/tidb6/executor/ConsumeRandomPanic"
	require.NoError(t, failpoint.Enable(fpName, "5%panic(\"ERROR 1105 (HY000): Out Of Memory Quota![conn_id=1]\")"))
	defer func() {
		require.NoError(t, failpoint.Disable(fpName))
	}()
	fpName2 := "github.com/wuhuizuo/tidb6/store/copr/ConsumeRandomPanic"
...
// https://github.com/wuhuizuo/tidb6/issues/27751
