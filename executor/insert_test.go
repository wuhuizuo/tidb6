...
func TestInsertOnDuplicateKeyWithBinlog(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	failpoint.Enable("github.com/wuhuizuo/tidb6/table/tables/forceWriteBinlog", "return")
	defer failpoint.Disable("github.com/wuhuizuo/tidb6/table/tables/forceWriteBinlog")
	testInsertOnDuplicateKey(t, tk)
}
...
// Fix https://github.com/wuhuizuo/tidb6/issues/32601.
...
func TestDuplicateEntryMessage(t *testing.T) {
	...
	for _, enable := range []variable.ClusteredIndexDefMode{variable.ClusteredIndexDefModeOn, variable.ClusteredIndexDefModeOff, variable.ClusteredIndexDefModeIntOnly} {
		...
		// See https://github.com/wuhuizuo/tidb6/issues/12420.
		tk.MustExec("drop table if exists t;")
...
// TestDuplicatedEntryErr See https://github.com/wuhuizuo/tidb6/issues/24582
...
// https://github.com/wuhuizuo/tidb6/issues/29483.
...
// https://github.com/wuhuizuo/tidb6/issues/32213.
