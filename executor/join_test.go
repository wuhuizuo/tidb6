...
func TestIndexNestedLoopHashJoin(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/planner/core/MockOnlyEnableIndexHashJoin", "return(true)"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/planner/core/MockOnlyEnableIndexHashJoin"))
	}()
	tk.MustExec("drop table t")
...
func TestIssue18070(t *testing.T) {
	...
	fpName := "github.com/wuhuizuo/tidb6/executor/mockIndexMergeJoinOOMPanic"
...
func TestIssue18572_1(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/testIndexHashJoinInnerWorkerErr", "return"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/testIndexHashJoinInnerWorkerErr"))
	}()
...
func TestIssue18572_3(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/testIndexHashJoinBuildErr", "return"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/testIndexHashJoinBuildErr"))
	}()
...
func TestIssue20270(t *testing.T) {
	...
	tk.MustExec("insert into t values(1,1),(2,2)")
	tk.MustExec("insert into t1 values(2,3),(4,4)")
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/killedInJoin2Chunk", "return(true)"))
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/killedInJoin2Chunk"))
	plannercore.ForceUseOuterBuild4Test.Store(true)
	defer func() {
		plannercore.ForceUseOuterBuild4Test.Store(false)
	}()
	err = failpoint.Enable("github.com/wuhuizuo/tidb6/executor/killedInJoin2ChunkForOuterHashJoin", "return(true)")
	require.NoError(t, err)
	...
	require.Equal(t, executor.ErrQueryInterrupted, err)
	err = failpoint.Disable("github.com/wuhuizuo/tidb6/executor/killedInJoin2ChunkForOuterHashJoin")
	require.NoError(t, err)
}
...
func TestIssue20779(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/testIssue20779", "return"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/testIssue20779"))
	}()
...
func TestIssue30211(t *testing.T) {
	...
	tk.MustExec("create table t2(a int, index(a));")
	func() {
		fpName := "github.com/wuhuizuo/tidb6/executor/TestIssue30211"
...
func TestIssue31129(t *testing.T) {
	...
	// Test IndexNestedLoopHashJoin keepOrder.
	fpName := "github.com/wuhuizuo/tidb6/executor/TestIssue31129"
	...
	fpName = "github.com/wuhuizuo/tidb6/executor/IndexHashJoinBuildHashTablePanic"
	...
	fpName = "github.com/wuhuizuo/tidb6/executor/IndexHashJoinFetchInnerResultsErr"
	require.NoError(t, failpoint.Enable(fpName, "return"))
	err = tk.QueryToErr("select /*+ INL_HASH_JOIN(s) */ * from t left join s on t.a=s.a order by t.pk")
	...
	fpName1, fpName2 := "github.com/wuhuizuo/tidb6/executor/IndexHashJoinBuildHashTablePanicgithub.com/wuhuizuo/tidb6idb6idb6/executor/IndexHashJoinFetchInnerResultsErr"
