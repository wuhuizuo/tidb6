...
import (
	...
	"github.com/wuhuizuo/tidb6/util/deadlockhistory"
)
...
func TestPointGetRepeatableRead(t *testing.T) {
	...
	var (
		step1 = "github.com/wuhuizuo/tidb6/executor/pointGetRepeatableReadTest-step1"
		step2 = "github.com/wuhuizuo/tidb6/executor/pointGetRepeatableReadTest-step2"
	)
...
func TestBatchPointGetRepeatableRead(t *testing.T) {
	...
	var (
		step1 = "github.com/wuhuizuo/tidb6/executor/batchPointGetRepeatableReadTest-step1"
		step2 = "github.com/wuhuizuo/tidb6/executor/batchPointGetRepeatableReadTest-step2"
	)
...
func TestTSOFail(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/session/mockGetTSFail", "return"))
	ctx := failpoint.WithHook(context.Background(), func(ctx context.Context, fpname string) bool {
		return fpname == "github.com/wuhuizuo/tidb6/session/mockGetTSFail"
	})
	_, err := tk.Session().Execute(ctx, `select * from t`)
	require.Error(t, err)
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/session/mockGetTSFail"))
}
...
func TestCoprocessorOOMTiCase(t *testing.T) {
	...
	err := failpoint.Enable("github.com/wuhuizuo/tidb6/store/copr/ticase-4169", `return(true)`)
	require.NoError(t, err)
	f()
	err = failpoint.Disable("github.com/wuhuizuo/tidb6/store/copr/ticase-4169")
	require.NoError(t, err)
	// ticase-4170, trigger oom action twice after iterator receiving all the data.
	err = failpoint.Enable("github.com/wuhuizuo/tidb6/store/copr/ticase-4170", `return(true)`)
	require.NoError(t, err)
	f()
	err = failpoint.Disable("github.com/wuhuizuo/tidb6/store/copr/ticase-4170")
	require.NoError(t, err)
	// ticase-4171, trigger oom before reading or consuming any data
	err = failpoint.Enable("github.com/wuhuizuo/tidb6/store/copr/ticase-4171", `return(true)`)
	require.NoError(t, err)
	f()
	err = failpoint.Disable("github.com/wuhuizuo/tidb6/store/copr/ticase-4171")
	require.NoError(t, err)
}

func TestIssue21441(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/issue21441", `return`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/issue21441"))
	}()
...
func TestTxnWriteThroughputSLI(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/util/sli/CheckTxnWriteThroughput", "return(true)"))
	defer func() {
		err := failpoint.Disable("github.com/wuhuizuo/tidb6/util/sli/CheckTxnWriteThroughput")
		require.NoError(t, err)
	}()
...
func TestDeadlocksTable(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/expression/sqlDigestRetrieverSkipRetrieveGlobal", "return"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/expression/sqlDigestRetrieverSkipRetrieveGlobal"))
	}()
