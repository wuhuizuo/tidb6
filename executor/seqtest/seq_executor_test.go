...
import (
	...
	ddltestutil "github.com/wuhuizuo/tidb6/ddl/testutil"
	"github.com/wuhuizuo/tidb6/ddl/util"
	...
	"github.com/wuhuizuo/tidb6/store/copr"
	...
	"github.com/wuhuizuo/tidb6/util/gcutil"
)
...
func TestEarlyClose(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/store/copr/handleTaskOnceError", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/copr/handleTaskOnceError"))
	}()
...
func TestShow(t *testing.T) {
	...
	row := result.Rows()[0]
	// For issue https://github.com/wuhuizuo/tidb6/issues/1061
	...
	// For issue https://github.com/wuhuizuo/tidb6/issues/1918
	...
	// for issue https://github.com/wuhuizuo/tidb6/issues/4224
	...
	// for issue https://github.com/wuhuizuo/tidb6/issues/3747
	...
	// for issue https://github.com/wuhuizuo/tidb6/issues/4678
	...
	// for issue https://github.com/wuhuizuo/tidb6/issues/4411
	...
	// for issue https://github.com/wuhuizuo/tidb6/issues/4424
	...
	// for issue https://github.com/wuhuizuo/tidb6/issues/4425
	tk.MustExec("drop table if exists show_test")
	testSQL = `create table show_test(
	...
	// for issue https://github.com/wuhuizuo/tidb6/issues/4426
	tk.MustExec("drop table if exists show_test")
	testSQL = `create table show_test(
		a bit(1),
...
func TestIndexMergeReaderClose(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/startPartialIndexWorkerErr", "return"))
	err := tk.QueryToErr("select /*+ USE_INDEX_MERGE(t, idx1, idx2) */ * from t where a > 10 or b < 100")
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/startPartialIndexWorkerErr"))
	require.Error(t, err)
...
func TestParallelHashAggClose(t *testing.T) {
	...
	// Goroutine should not leak when error happen.
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/parallelHashAggError", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/parallelHashAggError"))
	}()
	ctx := context.Background()
...
func TestUnparallelHashAggClose(t *testing.T) {
	...
	// Goroutine should not leak when error happen.
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/unparallelHashAggError", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/unparallelHashAggError"))
	}()
	ctx := context.Background()
...
func HelperTestAdminShowNextID(t *testing.T, store kv.Storage, str string) {
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/meta/autoid/mockAutoIDChange", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/meta/autoid/mockAutoIDChange"))
	}()
	step := int64(10)
	autoIDStep := autoid.GetStep()
	autoid.SetStep(step)
...
func TestNoHistoryWhenDisableRetry(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/session/keepHistory", `return(true)`))
	tk.MustExec("insert history values (1)")
	require.Equal(t, 1, session.GetHistory(tk.Session()).Count())
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/session/keepHistory"))
	tk.MustExec("begin")
	tk.MustExec("insert history values (1)")
	require.Equal(t, 0, session.GetHistory(tk.Session()).Count())
	tk.MustExec("commit")
...
func TestAutoIncIDInRetry(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/session/mockCommitRetryForAutoIncID", `return(true)`))
	tk.MustExec("commit")
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/session/mockCommitRetryForAutoIncID"))
...
func TestAutoRandIDRetry(t *testing.T) {
	...
	fpName := "github.com/wuhuizuo/tidb6/session/mockCommitRetryForAutoRandID"
...
func TestOOMPanicInHashJoinWhenFetchBuildRows(t *testing.T) {
	...
	tk.MustExec("insert into t values(1,1),(2,2)")
	fpName := "github.com/wuhuizuo/tidb6/executor/errorFetchBuildSideRowsMockOOMPanic"
...
func TestIssue18744(t *testing.T) {
  ...
  KEY f (f)
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/testIndexHashJoinOuterWorkerErr", "return"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/testIndexHashJoinOuterWorkerErr"))
	}()
...
func TestAnalyzeNextRawErrorNoLeak(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/distsql/mockNextRawError", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/distsql/mockNextRawError"))
	}()
