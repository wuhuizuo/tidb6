...
import (
	...
	"github.com/wuhuizuo/tidb6/planner"
	...
	error2 "github.com/wuhuizuo/tidb6/store/driver/error"
	...
	"github.com/wuhuizuo/tidb6/util/rowcodec"
...
func TestOrderBy(t *testing.T) {
	...
	// Fix issue https://github.com/wuhuizuo/tidb6/issues/337
...
func TestJSON(t *testing.T) {
	...
	// TODO: Fix bug https://github.com/wuhuizuo/tidb6/issues/12178
	// tk.MustExec("drop table if exists test_json")
...
func TestSetOperation(t *testing.T) {
	...
	// from https://github.com/wuhuizuo/tidb6/issues/40279
...
func TestTimestampTimeZone(t *testing.T) {
	...
	// For issue https://github.com/wuhuizuo/tidb6/issues/3467
	tk.MustExec("drop table if exists t1")
	...
	// For issue https://github.com/wuhuizuo/tidb6/issues/3485
...
func TestEmptyEnum(t *testing.T) {
	...
	// Test https://github.com/wuhuizuo/tidb6/issues/29525.
	tk.MustExec("drop table if exists t;")
...
// fix issue https://github.com/wuhuizuo/tidb6/issues/32871
...
// https://github.com/wuhuizuo/tidb6/issues/24165.
...
func TestAdminShowDDLJobsRowCount(t *testing.T) {
	...
	// Test for issue: https://github.com/wuhuizuo/tidb6/issues/25968
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t;")
...
func TestAdminShowDDLJobsInfo(t *testing.T) {
	...
	// Test for issue: https://github.com/wuhuizuo/tidb6/issues/29915
...
func TestColumnName(t *testing.T) {
	...
	// Test issue https://github.com/wuhuizuo/tidb6/issues/9639 .
	...
	for _, isolation := range []string{
		...
		for _, setSnapshotBeforeTxn := range []bool{false, true} {
			t.Run(fmt.Sprintf("[%s] setSnapshotBeforeTxn[%v]", isolation, setSnapshotBeforeTxn), func(t *testing.T) {
				...
				// See issue: https://github.com/wuhuizuo/tidb6/issues/34529
...
func TestCompileOutOfMemoryQuota(t *testing.T) {
	...
	// Test for issue: https://github.com/wuhuizuo/tidb6/issues/38322
	defer tk.MustExec("set global tidb_mem_oom_action = DEFAULT")
	tk.MustExec("set global tidb_mem_oom_action='CANCEL'")
	tk.MustExec("use test")
	tk.MustExec("create table t(a int, b int, index idx(a))")
...
func TestSignalCheckpointForSort(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/SignalCheckpointForSort", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/SignalCheckpointForSort"))
	}()
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/util/chunk/SignalCheckpointForSort", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/util/chunk/SignalCheckpointForSort"))
	}()
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
