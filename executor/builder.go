...
import (
	...
	"github.com/wuhuizuo/tidb6/distsql"
	...
	plannerutil "github.com/wuhuizuo/tidb6/planner/util"
	...
	"github.com/wuhuizuo/tidb6/util/cteutil"
...
func (b *executorBuilder) buildProjection(v *plannercore.PhysicalProjection) Executor {
	...
	// See also https://github.com/wuhuizuo/tidb6/issues/26832
...
func (b *executorBuilder) getAdjustedSampleRate(sctx sessionctx.Context, task plannercore.AnalyzeColumnsTask) float64 {
	...
	// we have issue https://github.com/wuhuizuo/tidb6/issues/29216.
...
func (b *executorBuilder) buildIndexLookUpJoin(v *plannercore.PhysicalIndexJoin) Executor {
	...
	for i, col := range innerPlan.Schema().Columns {
		...
		// truncate error. See issue https://github.com/wuhuizuo/tidb6/issues/21232 for example.
