...
func TestSpillToDisk(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/testCTEStorageSpill", "return(true)"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/testCTEStorageSpill"))
...
// https://github.com/wuhuizuo/tidb6/issues/33965.
...
func TestCTEPanic(t *testing.T) {
	...
	fpPathPrefix := "github.com/wuhuizuo/tidb6/executor/"
	fp := "testCTESeedPanic"
