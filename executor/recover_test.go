...
func TestRecoverTableMeetError(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockUpdateVersionAndTableInfoErr", `return(1)`))
	tk.MustContainErrMsg("recover table t_recover", "mock update version and tableInfo error")
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockUpdateVersionAndTableInfoErr"))
...
func TestRecoverClusterMeetError(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockFlashbackTest", `return(true)`))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/injectSafeTS",
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/injectSafeTS"))
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockFlashbackTest"))
}
...
func TestFlashbackWithSafeTs(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockFlashbackTest", `return(true)`))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/changeFlashbackGetMinSafeTimeTimeout", `return(0)`))
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/injectSafeTS"))
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockFlashbackTest"))
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/changeFlashbackGetMinSafeTimeTimeout"))
}
