...
func TestInspectionTables(t *testing.T) {
	...
	fpName := "github.com/wuhuizuo/tidb6/infoschema/mockClusterInfo"
...
// https://github.com/wuhuizuo/tidb6/issues/25467.
...
// https://github.com/wuhuizuo/tidb6/issues/32693.
...
func TestTiFlashSystemTableWithTiFlashV620(t *testing.T) {
	...
	fpName := "github.com/wuhuizuo/tidb6/infoschema/mockStoreServerInfo"
	fpExpr := `return("` + strings.Join(instances, ";") + `")`
	require.NoError(t, failpoint.Enable(fpName, fpExpr))
	defer func() { require.NoError(t, failpoint.Disable(fpName)) }()
...
// https://github.com/wuhuizuo/tidb6/issues/32459.
...
// https://github.com/wuhuizuo/tidb6/issues/36426.
