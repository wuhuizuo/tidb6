...
func TestIssue24210(t *testing.T) {
	...
	// for ProjectionExec
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/mockProjectionExecBaseExecutorOpenReturnedError", `return(true)`))
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/mockProjectionExecBaseExecutorOpenReturnedError"))

	// for HashAggExec
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/mockHashAggExecBaseExecutorOpenReturnedError", `return(true)`))
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/mockHashAggExecBaseExecutorOpenReturnedError"))

	// for StreamAggExec
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/mockStreamAggExecBaseExecutorOpenReturnedError", `return(true)`))
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/mockStreamAggExecBaseExecutorOpenReturnedError"))

	// for SelectionExec
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/mockSelectionExecBaseExecutorOpenReturnedError", `return(true)`))
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/mockSelectionExecBaseExecutorOpenReturnedError"))
}
...
func TestIssue30289(t *testing.T) {
	fpName := "github.com/wuhuizuo/tidb6/executor/issue30289"
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func TestIssue31678(t *testing.T) {
	...
	// https://github.com/wuhuizuo/tidb6/issues/31678
...
// Details at https://github.com/wuhuizuo/tidb6/issues/31038
func TestFix31038(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/store/copr/disable-collect-execution", `return(true)`))
	tk.MustQuery("select * from t123;")
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/copr/disable-collect-execution"))
}
...
// TestIssue2612 is related with https://github.com/wuhuizuo/tidb6/issues/2612
...
// TestIssue345 is related with https://github.com/wuhuizuo/tidb6/issues/345
...
// TestIssue4024 This tests https://github.com/wuhuizuo/tidb6/issues/4024
...
func TestIssue23567(t *testing.T) {
	...
	failpoint.Enable("github.com/wuhuizuo/tidb6/statistics/feedbackNoNDVCollect", `return("")`)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
	...
	failpoint.Disable("github.com/wuhuizuo/tidb6/statistics/feedbackNoNDVCollect")
}
...
func TestIssue42662(t *testing.T) {
	...
	tk.MustExec("set global tidb_mem_oom_action = 'cancel'")
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/issue42662_1", `return(true)`))
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/util/servermemorylimit/issue42662_2", `return(true)`))
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/issue42662_1"))
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/util/servermemorylimit/issue42662_2"))
}
