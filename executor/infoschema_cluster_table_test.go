...
func TestTiDBClusterInfo(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/infoschema/mockStoreTombstone", `return(true)`))
	tk.MustQuery("select type, instance, start_time from information_schema.cluster_info where type = 'tikv'").Check(testkit.Rows())
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/infoschema/mockStoreTombstone"))
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/infoschema/mockClusterInfo", fpExpr))
	defer func() { require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/infoschema/mockClusterInfo")) }()
