...
import (
	...
	"github.com/wuhuizuo/tidb6/util/paging"
)
...
// TestIssue10178 contains tests for https://github.com/wuhuizuo/tidb6/issues/10178 .
...
func TestAdaptiveClosestRead(t *testing.T) {
	...
	// See: https://github.com/wuhuizuo/tidb6/issues/31744#issuecomment-1016309883
...
func TestCoprocessorPagingReqKeyRangeSorted(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/store/copr/checkKeyRangeSortedForPaging", "return"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/copr/checkKeyRangeSortedForPaging"))
	}()
