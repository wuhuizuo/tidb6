...
func TestMultipleTableUpdate(t *testing.T) {
	...
	// fix https://github.com/wuhuizuo/tidb6/issues/369
	testSQL := `
	...
	// fix https://github.com/wuhuizuo/tidb6/issues/376
	...
	// test https://github.com/wuhuizuo/tidb6/issues/3604
...
func TestIssue33298(t *testing.T) {
	...
	// loop in `indexOfTerminator` (see https://github.com/wuhuizuo/tidb6/issues/33298).
...
// TestIssue4067 Test issue https://github.com/wuhuizuo/tidb6/issues/4067
...
func TestHandleColumnWithOnUpdateCurrentTimestamp(t *testing.T) {
	// Test https://github.com/wuhuizuo/tidb6/issues/44565
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
