...
use test;
select * from t;`
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/errorMockParseSlowLogPanic", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/errorMockParseSlowLogPanic"))
	}()
...
select * from t;`
	...
	err = failpoint.Enable("github.com/wuhuizuo/tidb6/executor/mockReadSlowLogSlow", "return(true)")
	require.NoError(t, err)
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/mockReadSlowLogSlow"))
	}()
	go func() {
