...
// https://github.com/wuhuizuo/tidb6/issues/27687.
...
func TestDecodeBadDecical(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/util/codec/errorInDecodeDecimal", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/util/codec/errorInDecodeDecimal"))
	}()
