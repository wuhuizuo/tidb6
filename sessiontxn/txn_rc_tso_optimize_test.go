...
import (
	...
	"github.com/wuhuizuo/tidb6/sessiontxn/isolation"
...
func TestRcTSOCmdCountForPrepareExecuteNormal(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/sessiontxn/isolation/tsoUseConstantFuture", "return"))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/sessiontxn/isolation/waitTsoOfOracleFuture", "return"))

	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/sessiontxn/isolation/requestTsoFromPD"))
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/sessiontxn/isolation/tsoUseConstantFuture"))
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/sessiontxn/isolation/waitTsoOfOracleFuture"))
	}()
...
func TestConflictErrorsUseRcWriteCheckTs(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/assertPessimisticLockErr", "return"))
	store := testkit.CreateMockStore(t)
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/assertPessimisticLockErr"))
}
