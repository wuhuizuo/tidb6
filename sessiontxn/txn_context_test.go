...
import (
	...
	"github.com/wuhuizuo/tidb6/testkit/testfork"
...
func setupTxnContextTest(t *testing.T) (kv.Storage, *domain.Domain) {
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/assertTxnManagerInCompile", "return"))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/assertTxnManagerInRebuildPlan", "return"))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/assertTxnManagerAfterBuildExecutor", "return"))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/assertTxnManagerAfterPessimisticLockErrorRetry", "return"))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/assertTxnManagerInShortPointGetPlan", "return"))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/session/assertTxnManagerInRunStmt", "return"))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/session/assertTxnManagerInCachedPlanExec", "return"))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/session/assertTxnManagerForUpdateTSEqual", "return"))
	...
	t.Cleanup(func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/assertTxnManagerInCompile"))
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/assertTxnManagerInRebuildPlan"))
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/assertTxnManagerAfterBuildExecutor"))
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/assertTxnManagerAfterPessimisticLockErrorRetry"))
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/assertTxnManagerInShortPointGetPlan"))
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/session/assertTxnManagerInRunStmt"))
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/session/assertTxnManagerInCachedPlanExec"))
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/session/assertTxnManagerForUpdateTSEqual"))
...
// See issue: https://github.com/wuhuizuo/tidb6/issues/35459
...
func TestTSOCmdCountForPrepareExecute(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/sessiontxn/isolation/requestTsoFromPD", "return"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/sessiontxn/isolation/requestTsoFromPD"))
	}()
