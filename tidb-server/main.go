...
import (
	...
	"github.com/wuhuizuo/tidb6/bindinfo"
	...
	"github.com/wuhuizuo/tidb6/plugin"
	"github.com/wuhuizuo/tidb6/privilege/privileges"
	"github.com/wuhuizuo/tidb6/server"
	"github.com/wuhuizuo/tidb6/session"
	"github.com/wuhuizuo/tidb6/session/txninfo"
	"github.com/wuhuizuo/tidb6/sessionctx/binloginfo"
	"github.com/wuhuizuo/tidb6/sessionctx/variable"
	"github.com/wuhuizuo/tidb6/statistics"
	kvstore "github.com/wuhuizuo/tidb6/store"
	"github.com/wuhuizuo/tidb6/store/copr"
	"github.com/wuhuizuo/tidb6/store/driver"
	"github.com/wuhuizuo/tidb6/store/mockstore"
	uni_metrics "github.com/wuhuizuo/tidb6/store/mockstore/unistore/metrics"
	pumpcli "github.com/wuhuizuo/tidb6/tidb-binlog/pump_client"
	...
	"github.com/wuhuizuo/tidb6/util/disk"
	"github.com/wuhuizuo/tidb6/util/domainutil"
	"github.com/wuhuizuo/tidb6/util/kvcache"
	"github.com/wuhuizuo/tidb6/util/logutil"
	"github.com/wuhuizuo/tidb6/util/memory"
	"github.com/wuhuizuo/tidb6/util/printer"
	"github.com/wuhuizuo/tidb6/util/sem"
	"github.com/wuhuizuo/tidb6/util/signal"
	"github.com/wuhuizuo/tidb6/util/sys/linux"
	storageSys "github.com/wuhuizuo/tidb6/util/sys/storage"
	"github.com/wuhuizuo/tidb6/util/systimemon"
	"github.com/wuhuizuo/tidb6/util/topsql"
	"github.com/wuhuizuo/tidb6/util/versioninfo"
...
func main() {
	...
	if _, err := failpoint.Status("github.com/wuhuizuo/tidb6/server/enableTestAPI"); err == nil {
	...
	// For regression of issue like https://github.com/wuhuizuo/tidb6/issues/28190
...
func cleanup(svr *server.Server, storage kv.Storage, dom *domain.Domain, graceful bool) {
	...
	if graceful {
		...
		// See https://github.com/wuhuizuo/tidb6/issues/40038 for details.
