...
// unit test for issue https://github.com/wuhuizuo/tidb6/issues/8518
...
// unit test for issue https://github.com/wuhuizuo/tidb6/issues/9478
...
func TestPrepareCacheForPartition(t *testing.T) {
	...
	for _, pruneMode := range []string{string(variable.Static), string(variable.Dynamic)} {
		...
		// https://github.com/wuhuizuo/tidb6/issues/33031
...
// Test for issue https://github.com/wuhuizuo/tidb6/issues/22167
...
func TestPartitionTable(t *testing.T) {
	...
	for _, tc := range testcases {
		...
		for i := 0; i < 100; i++ {
			tk.MustExec(fmt.Sprintf("set @a=%v", tc.varGener()))
			result1 := tk.MustQuery("execute stmt1 using @a").Sort().Rows()
			// When https://github.com/wuhuizuo/tidb6/pull/33098 is reverted this should be 1 again
