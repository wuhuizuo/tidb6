...
import (
	...
	"github.com/wuhuizuo/tidb6/parser/opcode"
	"github.com/wuhuizuo/tidb6/parser/terror"
	fd "github.com/wuhuizuo/tidb6/planner/funcdep"
	...
	driver "github.com/wuhuizuo/tidb6/types/parser_driver"
	util2 "github.com/wuhuizuo/tidb6/util"
	...
	"github.com/wuhuizuo/tidb6/util/hint"
	...
	"github.com/wuhuizuo/tidb6/util/size"
)
...
func unionJoinFieldType(a, b *types.FieldType) *types.FieldType {
	...
	if resultTp.GetType() == mysql.TypeNewDecimal {
		...
		// ref2: https://github.com/wuhuizuo/tidb6/issues/24953
...
func (b *PlanBuilder) buildSetOpr(ctx context.Context, setOpr *ast.SetOprStmt) (LogicalPlan, error) {
	...
	// Fix issue #8189 (https://github.com/wuhuizuo/tidb6/issues/8189).
...
func (b *PlanBuilder) addAliasName(ctx context.Context, selectStmt *ast.SelectStmt, p LogicalPlan) (resultList []*ast.SelectField, err error) {
	...
	// See: https://github.com/wuhuizuo/tidb6/issues/29326
...
func (b *PlanBuilder) buildDataSource(ctx context.Context, tn *ast.TableName, asName *model.CIStr) (LogicalPlan, error) {
	...
	// see detail in issue: https://github.com/wuhuizuo/tidb6/issues/39543
