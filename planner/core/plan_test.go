...
func TestNormalizedDigest(t *testing.T) {
	...
	err := failpoint.Enable("github.com/wuhuizuo/tidb6/planner/mockRandomPlanID", "return(true)")
	require.NoError(t, err)
	defer func() {
		err = failpoint.Disable("github.com/wuhuizuo/tidb6/planner/mockRandomPlanID")
		require.NoError(t, err)
	}()
...
// https://github.com/wuhuizuo/tidb6/issues/35527.
...
// https://github.com/wuhuizuo/tidb6/issues/38310
...
// https://github.com/wuhuizuo/tidb6/issues/38304
// https://github.com/wuhuizuo/tidb6/issues/38654
