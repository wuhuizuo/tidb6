...
func TestBuildUpdateListResolver(t *testing.T) {
	...
	// For issue https://github.com/wuhuizuo/tidb6/issues/24567
	tk.MustExec("drop table if exists t")
	...
	// For issue https://github.com/wuhuizuo/tidb6/issues/30031
...
func TestSysdatePushDown(t *testing.T) {
	...
	tk.MustQuery("explain analyze select /*+read_from_storage(tikv[t])*/ * from t where d > sysdate()").
		CheckAt([]int{0, 3, 6}, rows)
	failpoint.Disable("github.com/wuhuizuo/tidb6/expression/injectNow")
...
// Test for issue https://github.com/wuhuizuo/tidb6/issues/21607.
...
// Test for issue https://github.com/wuhuizuo/tidb6/issues/18320
...
// https://github.com/wuhuizuo/tidb6/issues/23802
...
// https://github.com/wuhuizuo/tidb6/issues/24095
...
// TestSequenceAsDataSource is used to test https://github.com/wuhuizuo/tidb6/issues/24383.
...
// TestIsMatchProp is used to test https://github.com/wuhuizuo/tidb6/issues/26017.
...
// https://github.com/wuhuizuo/tidb6/issues/26214
...
func TestIssue30804(t *testing.T) {
	...
	tk.MustExec("create table t1(a int, b int)")
	tk.MustExec("create table t2(a int, b int)")
	// minimal reproduction of https://github.com/wuhuizuo/tidb6/issues/30804
...
// Close https://github.com/wuhuizuo/tidb6/issues/31096
...
func TestExplainAnalyzeDMLCommit(t *testing.T) {
	...
	err := failpoint.Enable("github.com/wuhuizuo/tidb6/session/mockSleepBeforeTxnCommit", "return(500)")
	require.NoError(t, err)
	defer func() {
		_ = failpoint.Disable("github.com/wuhuizuo/tidb6/session/mockSleepBeforeTxnCommit")
	}()
...
// https://github.com/wuhuizuo/tidb6/issues/38295.
...
// https://github.com/wuhuizuo/tidb6/issues/41273
...
// https://github.com/wuhuizuo/tidb6/issues/41355
...
// https://github.com/wuhuizuo/tidb6/issues/41458
