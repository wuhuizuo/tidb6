...
import (
	...
	tidbmetrics "github.com/wuhuizuo/tidb6/metrics"
	...
	"github.com/wuhuizuo/tidb6/store/driver/options"
	...
	"github.com/wuhuizuo/tidb6/util/trxevents"
	"go.uber.org/zap"
)
...
func (c *CopClient) BuildCopIterator(ctx context.Context, req *kv.Request, vars *tikv.Variables, option *kv.ClientSendOption) (*copIterator, kv.Response) {
	...
	if it.req.KeepOrder {
		...
		// For ReqTypeAnalyze, we keep its concurrency to avoid slow analyze(see https://github.com/wuhuizuo/tidb6/issues/40162 for details).
