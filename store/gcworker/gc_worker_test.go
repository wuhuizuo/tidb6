...
func TestDeleteRangesFailure(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/store/gcworker/mockHistoryJobForGC", "return(1)"))
			defer func() {
				require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/gcworker/mockHistoryJobForGC"))
			}()
...
func TestResolveLockRangeInfine(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/store/gcworker/setGcResolveMaxBackoff", "return(1)"))
	defer func() {
		require.NoError(t, failpoint.Disable("tikvclient/invalidCacheAndRetry"))
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/gcworker/setGcResolveMaxBackoff"))
	}()
...
func TestResolveLockRangeMeetRegionEnlargeCausedByRegionMerge(t *testing.T) {
	...
	failpoint.Enable("github.com/wuhuizuo/tidb6/store/copr/DisablePaging", `return`)
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/copr/DisablePaging"))
	}()
...
func TestResolveLocksPhysical(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/store/gcworker/resolveLocksAcrossRegionsErr", "return(100)"))
	physicalUsed, err = s.gcWorker.resolveLocks(ctx, safePoint, 3, true)
	require.False(t, physicalUsed)
	require.NoError(t, err)
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/gcworker/resolveLocksAcrossRegionsErr"))
	...
	wg.Add(1)
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/store/gcworker/beforeCheckLockObservers", "pause"))
	go func() {
		defer wg.Done()
		physicalUsed, err := s.gcWorker.resolveLocks(ctx, safePoint, 3, true)
		require.True(t, physicalUsed)
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/gcworker/beforeCheckLockObservers"))
	wg.Wait()
...
func TestPhysicalScanLockDeadlock(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/store/gcworker/resolveLocksAcrossRegionsErr", "return(1000)"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/gcworker/resolveLocksAcrossRegionsErr"))
	}()
...
func TestGCPlacementRules(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/store/gcworker/mockHistoryJobForGC", "return(10)"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/gcworker/mockHistoryJobForGC"))
	}()
	...
	require.NoError(t, failpoint.EnableWith("github.com/wuhuizuo/tidb6/store/gcworker/gcDeletePlacementRuleCounter", "return", func() error {
		deletePlacementRuleCounter++
		return nil
	}))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/gcworker/gcDeletePlacementRuleCounter"))
	}()
...
func TestGCLabelRules(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/store/gcworker/mockHistoryJob", "return(\"schema/d1/t1\")"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/gcworker/mockHistoryJob"))
	}()
