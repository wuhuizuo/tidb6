...
func main() {
	...
	const prefix = "github.com/wuhuizuo/tidb6/"
	if !strings.HasPrefix(pkg, prefix) {
		os.Exit(-3)
	}

	// github.com/wuhuizuo/tidb6/util/topsql.test => util/topsql
...
func getPackageInfo(dir string) string {
	...
	r := bufio.NewReader(f)
	// packagefile github.com/wuhuizuo/tidb6/session.test=/home/genius/.cache/go-build/fb/fb1587cce5727fa9461131eab8260a52878da04f5c8da49dd3c7b2d941430c63-d
