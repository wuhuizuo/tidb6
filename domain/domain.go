...
import (
	...
	"github.com/wuhuizuo/tidb6/br/pkg/streamhelper"
	"github.com/wuhuizuo/tidb6/br/pkg/streamhelper/daemon"
	...
	"github.com/wuhuizuo/tidb6/util/engine"
	"github.com/wuhuizuo/tidb6/util/expensivequery"
	"github.com/wuhuizuo/tidb6/util/logutil"
	"github.com/wuhuizuo/tidb6/util/memory"
	"github.com/wuhuizuo/tidb6/util/memoryusagealarm"
	"github.com/wuhuizuo/tidb6/util/servermemorylimit"
...
type Domain struct {
	...
	expiredTimeStamp4PC     struct {
		...
		// and compiler.Compile(), see issue https://github.com/wuhuizuo/tidb6/issues/45400
		sync.RWMutex
...
func (do *Domain) Init(
	...
	if ebd, ok := do.store.(kv.EtcdBackend); ok {
		...
		if addrs != nil {
			...
			// see details at the issue https://github.com/wuhuizuo/tidb6/issues/15479
