...
func TestInfo(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/domain/infosync/FailPlacement", `return(true)`))
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/domain/MockReplaceDDL", `return(true)`))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/NoDDLDispatchLoop", `return(true)`))
	require.NoError(t, dom.Init(ddlLease, sysMockFactory, nil))
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/NoDDLDispatchLoop"))
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/domain/MockReplaceDDL"))
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/syncer/ErrorMockSessionDone", `return(true)`))
	<-dom.ddl.SchemaSyncer().Done()
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/syncer/ErrorMockSessionDone"))
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/domain/infosync/FailPlacement"))
}
...
func TestClosestReplicaReadChecker(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/domain/infosync/mockGetAllServerInfo", makeFailpointRes(mockedAllServerInfos)))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/domain/infosync/mockGetServerInfo", makeFailpointRes(mockedAllServerInfos["s2"])))
	...
	for _, c := range cases {
		require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/domain/infosync/mockGetServerInfo", makeFailpointRes(mockedAllServerInfos[c.id])))
	...
	variable.SetEnableAdaptiveReplicaRead(true)
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/domain/infosync/mockGetAllServerInfo"))
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/domain/infosync/mockGetServerInfo"))
}
