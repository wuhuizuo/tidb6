...
func TestTopology(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/domain/infosync/mockServerInfo", "return(true)"))
	defer func() {
		err := failpoint.Disable("github.com/wuhuizuo/tidb6/domain/infosync/mockServerInfo")
...
func TestPutBundlesRetry(t *testing.T) {
	...
	t.Run("serviceErrorShouldNotRetry", func(t *testing.T) {
		...
		require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/domain/infosync/putRuleBundlesError", "1*return(true)"))
		defer func() {
			require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/domain/infosync/putRuleBundlesError"))
		}()
	...
	t.Run("nonServiceErrorShouldRetry", func(t *testing.T) {
		require.NoError(t, PutRuleBundles(context.TODO(), []*placement.Bundle{{ID: bundle.ID}}))
		require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/domain/infosync/putRuleBundlesError", "3*return(false)"))
		defer func() {
			require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/domain/infosync/putRuleBundlesError"))
		}()
	...
	t.Run("nonServiceErrorRetryAndFail", func(t *testing.T) {
		require.NoError(t, PutRuleBundles(context.TODO(), []*placement.Bundle{{ID: bundle.ID}}))
		require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/domain/infosync/putRuleBundlesError", "4*return(false)"))
		defer func() {
			require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/domain/infosync/putRuleBundlesError"))
		}()
