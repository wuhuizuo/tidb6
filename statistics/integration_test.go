...
func TestExpBackoffEstimation(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/statistics/cleanEstResults", `return(true)`))
	testdata.OnRecord(func() {
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/statistics/cleanEstResults"))
}
