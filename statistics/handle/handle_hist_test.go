...
func TestSyncLoadSkipUnAnalyzedItems(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/statistics/handle/assertSyncLoadItems", `return(0)`))
	tk.MustQuery("trace plan select * from t where a > 10")
	failpoint.Disable("github.com/wuhuizuo/tidb6/statistics/handle/assertSyncLoadItems")
	tk.MustExec("analyze table t1")
	// one column would be loaded
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/statistics/handle/assertSyncLoadItems", `return(1)`))
...
func TestConcurrentLoadHistWithPanicAndFail(t *testing.T) {
	...
	failpoints := []struct {
		...
		{
			failPath: "github.com/wuhuizuo/tidb6/statistics/handle/mockReadStatsForOnePanic",
			inTerms:  "panic",
		},
		{
			failPath: "github.com/wuhuizuo/tidb6/statistics/handle/mockReadStatsForOneFail",
			inTerms:  "return(true)",
		},
	}
