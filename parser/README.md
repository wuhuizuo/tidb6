...
- Highly compatible with MySQL: it supports almost all features of MySQL. For the complete details, see [parser.y](https://github.com/wuhuizuo/tidb6/blob/master/parser/parser.y) and [hintparser.y](https://github.com/wuhuizuo/tidb6/blob/master/parser/hintparser.y).
...
Please read the [quickstart](https://github.com/wuhuizuo/tidb6/blob/master/parser/docs/quickstart.md).
...
- [GitHub Issue](https://github.com/wuhuizuo/tidb6/issues)
...
- [pingcap/tidb](https://github.com/wuhuizuo/tidb6)
