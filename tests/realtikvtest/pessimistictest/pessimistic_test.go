...
import (
	...
	"github.com/wuhuizuo/tidb6/tests/realtikvtest"
...
func TestAsyncRollBackNoWait(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/executor/ExecStmtGetTsError", "return"))
	require.NoError(t, failpoint.Enable("tikvclient/beforeAsyncPessimisticRollback", "sleep(100)"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/executor/ExecStmtGetTsError"))
	...
	// TODO: @coocood skip the following test in https://github.com/wuhuizuo/tidb6/pull/13553/
...
func TestBatchResolveLocks(t *testing.T) {
	...
	// ----------------
	// Simulate issue https://github.com/wuhuizuo/tidb6/issues/43243
	...
	// ----------------
	// Simulate issue https://github.com/wuhuizuo/tidb6/issues/45134
	tk.MustExec("begin pessimistic")
