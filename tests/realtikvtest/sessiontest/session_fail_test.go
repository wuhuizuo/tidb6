...
func TestFailStatementCommitInRetry(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/session/mockCommitError8942", `return(true)`))
	_, err := tk.Exec("commit")
	require.Error(t, err)
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/session/mockCommitError8942"))
...
func TestGetTSFailDirtyStateInretry(t *testing.T) {
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/session/mockCommitError"))
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/session/mockCommitError", `return(true)`))
