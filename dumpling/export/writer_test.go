...
func TestWriteTableMeta(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/dumpling/export/FailToCloseMetaFile", "return(true)"))
	defer failpoint.Disable("github.com/wuhuizuo/tidb6/dumpling/export/FailToCloseMetaFile")
...
func TestWriteTableData(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/dumpling/export/FailToCloseDataFile", "return(true)"))
	defer failpoint.Disable("github.com/wuhuizuo/tidb6/dumpling/export/FailToCloseDataFile")
