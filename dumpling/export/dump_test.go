...
func TestSetSessionParams(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/dumpling/export/SkipResetDB", "return(true)"))
	defer failpoint.Disable("github.com/wuhuizuo/tidb6/dumpling/export/SkipResetDB=return(true)")
