...
import (
	...
	"github.com/wuhuizuo/tidb6/dumpling/cli"
	tcontext "github.com/wuhuizuo/tidb6/dumpling/context"
	"github.com/wuhuizuo/tidb6/dumpling/log"
...
func (d *Dumper) renewSelectTableRegionFuncForLowerTiDB(tctx *tcontext.Context) error {
	...
	// reference: https://github.com/wuhuizuo/tidb6/blob/c497d5c/dumpling/export/dump.go#L775
