...
export GO_FAILPOINTS="github.com/wuhuizuo/tidb6/dumpling/export/PrintTiDBMemQuotaQuery=1*return"
run_dumpling | tee ${DUMPLING_OUTPUT_DIR}/dumpling.log
...
export GO_FAILPOINTS="github.com/wuhuizuo/tidb6/dumpling/export/FailToCloseMetaFile=1*return"
...
export GO_FAILPOINTS="github.com/wuhuizuo/tidb6/dumpling/export/FailToCloseDataFile=1*return"
export DUMPLING_TEST_PORT=4000
...
export GO_FAILPOINTS="github.com/wuhuizuo/tidb6/dumpling/export/FailToCloseDataFile=5*return"
rm ${DUMPLING_OUTPUT_DIR}/dumpling.log
set +e
run_dumpling -B "test_db" -L ${DUMPLING_OUTPUT_DIR}/dumpling.log
set -e
