...
export GO_FAILPOINTS="github.com/wuhuizuo/tidb6/dumpling/export/SetWaitTimeout=return(2);github.com/wuhuizuo/tidb6/dumpling/export/SmallDumpChanSize=return();github.com/wuhuizuo/tidb6/dumpling/export/AtEveryRow=sleep(100)"
