...
export GO_FAILPOINTS="github.com/wuhuizuo/tidb6/dumpling/export/ChaosBrokenWriterConn=1*return;github.com/wuhuizuo/tidb6/dumpling/export/ChaosBrokenMetaConn=1*return"
