...
| -f or --filter | Dump only the tables matching the patterns. See [table-filter](https://github.com/wuhuizuo/tidb6-tools/blob/master/pkg/table-filter/README.md) for syntax. |
