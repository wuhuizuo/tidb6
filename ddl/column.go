...
import (
	...
	decoder "github.com/wuhuizuo/tidb6/util/rowDecoder"
...
func doReorgWorkForModifyColumn(w *worker, d *ddlCtx, t *meta.Meta, job *model.Job, tbl table.Table,
	...
	// enable: curl -X PUT -d "pause" "http://127.0.0.1:10080/fail/github.com/wuhuizuo/tidb6/ddl/mockDelayInModifyColumnTypeWithData".
	// disable: curl -X DELETE "http://127.0.0.1:10080/fail/github.com/wuhuizuo/tidb6/ddl/mockDelayInModifyColumnTypeWithData"
