...
func TestAddBatchJobError(t *testing.T) {
	...
	require.Nil(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockAddBatchDDLJobsErr", `return(true)`))
	...
	require.Nil(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockAddBatchDDLJobsErr"))
}
