...
func TestCreateTableWithPartition(t *testing.T) {
	...
	// Fix a timezone dependent check bug introduced in https://github.com/wuhuizuo/tidb6/pull/10655
	...
	// Fix https://github.com/wuhuizuo/tidb6/issues/16333
...
(partition p0pppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppppp values less than (10));`, errno.ErrTooLongIdent)
	...
	// Fix https://github.com/wuhuizuo/tidb6/issues/35827
...
func TestAlterTableExchangePartition(t *testing.T) {
	...
	require.Nil(t, failpoint.Enable("github.com/wuhuizuo/tidb6/infoschema/mockTiFlashStoreCount", `return(true)`))
	defer func() {
		err := failpoint.Disable("github.com/wuhuizuo/tidb6/infoschema/mockTiFlashStoreCount")
		require.NoError(t, err)
	}()
...
func TestExchangePartitionAutoID(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/exchangePartitionAutoID", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/exchangePartitionAutoID"))
	}()
...
func TestAddPartitionReplicaBiggerThanTiFlashStores(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockWaitTiFlashReplica", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockWaitTiFlashReplica"))
	}()
	require.True(t, t1.Meta().TiFlashReplica.Available)
...
func TestCreateAndAlterIntervalPartition(t *testing.T) {
	...
	// OK with out-of-range partitions, see https://github.com/wuhuizuo/tidb6/issues/36022
...
func TestPartitionTableWithAnsiQuotes(t *testing.T) {
	...
	// https://github.com/wuhuizuo/tidb6/issues/37692
	tk.MustExec("drop table t")
...
func TestAlterModifyPartitionColTruncateWarning(t *testing.T) {
	...
	// Fix the duplicate warning, see https://github.com/wuhuizuo/tidb6/issues/38699
	tk.MustQuery(`show warnings`).Check(testkit.Rows(""+
