...
import (
	...
	"github.com/wuhuizuo/tidb6/ddl"
	"github.com/wuhuizuo/tidb6/ddl/placement"
	ddlutil "github.com/wuhuizuo/tidb6/ddl/util"
	"github.com/wuhuizuo/tidb6/domain"
	"github.com/wuhuizuo/tidb6/domain/infosync"
	"github.com/wuhuizuo/tidb6/kv"
	"github.com/wuhuizuo/tidb6/parser/model"
	"github.com/wuhuizuo/tidb6/session"
	"github.com/wuhuizuo/tidb6/store/gcworker"
	"github.com/wuhuizuo/tidb6/store/mockstore"
...
func TestTiFlashNoRedundantPDRules(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/store/gcworker/ignoreDeleteRangeFailed", `return`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/gcworker/ignoreDeleteRangeFailed"))
	}()
...
func TestTiFlashReplicaPartitionTableBlock(t *testing.T) {
	...
	lessThan := "40"
	// Stop loop
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/BeforeRefreshTiFlashTickeLoop", `return`))
	defer func() {
		_ = failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/BeforeRefreshTiFlashTickeLoop")
	}()
...
func TestTiFlashFailTruncatePartition(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/FailTiFlashTruncatePartition", `return`))
	defer func() {
		failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/FailTiFlashTruncatePartition")
	}()
	time.Sleep(ddl.PollTiFlashInterval * RoundToBeAvailablePartitionTable)
...
func TestSetPlacementRuleWithGCWorker(t *testing.T) {
	...
	failpoint.Enable("github.com/wuhuizuo/tidb6/store/gcworker/ignoreDeleteRangeFailed", `return`)
	defer func() {
		failpoint.Disable("github.com/wuhuizuo/tidb6/store/gcworker/ignoreDeleteRangeFailed")
	}()
	fCancelPD := s.SetPdLoop(10000)
	defer fCancelPD()
...
func TestTiFlashBackoff(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/PollTiFlashReplicaStatusReplacePrevAvailableValue", `return(false)`))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/PollTiFlashReplicaStatusReplaceCurAvailableValue", `return(false)`))
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/PollTiFlashReplicaStatusReplacePrevAvailableValue"))
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/PollTiFlashReplicaStatusReplaceCurAvailableValue"))
...
func execWithTimeout(t *testing.T, tk *testkit.TestKit, to time.Duration, sql string) (bool, error) {
	...
	case <-ctx.Done():
		...
		require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/BatchAddTiFlashSendDone", "return(true)"))
	}

	e := <-doneCh
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/BatchAddTiFlashSendDone"))
	return true, e
}
...
func TestTiFlashBatchRateLimiter(t *testing.T) {
	...
	loop := 3
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/FastFailCheckTiFlashPendingTables", fmt.Sprintf("return(%v)", loop)))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/FastFailCheckTiFlashPendingTables"))
	}()
...
func TestTiFlashBatchKill(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/FastFailCheckTiFlashPendingTables", `return(2)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/FastFailCheckTiFlashPendingTables"))
	}()
...
func TestTiFlashProgressAvailableList(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/PollAvailableTableProgressMaxCount", `return(2)`))
	defer func() {
		_ = failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/PollAvailableTableProgressMaxCount")
	}()
...
func TestTiFlashAvailableAfterResetReplica(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/infoschema/mockTiFlashStoreCount", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/infoschema/mockTiFlashStoreCount"))
	}()
...
func TestTiFlashAvailableAfterAddPartition(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/sleepBeforeReplicaOnly", `return(2)`))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/waitForAddPartition", `return(3)`))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/PollTiFlashReplicaStatusReplaceCurAvailableValue", `return(false)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/sleepBeforeReplicaOnly"))
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/waitForAddPartition"))
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/PollTiFlashReplicaStatusReplaceCurAvailableValue"))
	}()
...
func TestTiFlashAvailableAfterDownOneStore(t *testing.T) {
	...
	tk.MustExec("drop table if exists ddltiflash")
	tk.MustExec("create table ddltiflash(z int) PARTITION BY RANGE(z) (PARTITION p0 VALUES LESS THAN (10))")
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/OneTiFlashStoreDown", `return`))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/domain/infosync/OneTiFlashStoreDown", `return`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/OneTiFlashStoreDown"))
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/domain/infosync/OneTiFlashStoreDown"))
	}()
