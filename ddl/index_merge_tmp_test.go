...
import (
	...
	"github.com/wuhuizuo/tidb6/ddl/ingest"
...
func TestAddIndexMergeDeleteNullUnique(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockDMLExecution", "1*return(true)->return(false)"))
	tk.MustExec("alter table t add unique index idx(a);")
	tk.MustQuery("select count(1) from t;").Check(testkit.Rows("1"))
	tk.MustExec("admin check table t;")
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockDMLExecution"))
}
...
func TestAddIndexMergeInsertOnMerging(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockDMLExecutionStateMerging", "return(true)"))
	tk.MustExec("alter table t add unique index idx(a);")
	tk.MustExec("admin check table t;")
	tk.MustQuery("select * from t;").Check(testkit.Rows("6 5"))
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockDMLExecutionStateMerging"))
}
...
func TestAddIndexMergeReplaceDelete(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockDMLExecutionMerging", "1*return(true)->return(false)"))
	tk.MustExec("alter table t add unique index idx(a);")
	tk.MustExec("admin check table t;")
	tk.MustQuery("select * from t;").Check(testkit.Rows())
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockDMLExecutionMerging"))
}
