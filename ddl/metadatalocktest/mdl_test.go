...
func TestMDLUpdateEtcdFail(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockUpdateMDLToETCDError", `3*return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockUpdateMDLToETCDError"))
	}()
