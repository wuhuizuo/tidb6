...
func TestCancelAddIndexPanic(t *testing.T) {
	...
	tk := testkit.NewTestKit(t, store)
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/errorMockPanic", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/errorMockPanic"))
	}()
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func TestRecoverTableByJobIDFail(t *testing.T) {
	...
	hook.OnJobRunBeforeExported = func(job *model.Job) {
		if job.Type == model.ActionRecoverTable {
			...
			require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockRecoverTableCommitErr", `return(true)`))
		}
	}
	dom.DDL().SetHook(hook)
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockRecoverTableCommitErr"))
...
func TestCancelJobByErrorCountLimit(t *testing.T) {
	store, _ := createMockStoreAndDomain(t)
	tk := testkit.NewTestKit(t, store)
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockExceedErrorLimit", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockExceedErrorLimit"))
	}()
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
...
func TestTruncateTableUpdateSchemaVersionErr(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockTruncateTableUpdateVersionError", `return(true)`))
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
	...
	// Disable fail point.
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockTruncateTableUpdateVersionError"))
...
func TestCreateTableNoBlock(t *testing.T) {
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/checkOwnerCheckAllVersionsWaitTime", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/checkOwnerCheckAllVersionsWaitTime"))
	}()
