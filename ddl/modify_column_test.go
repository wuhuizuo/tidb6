...
func TestModifyColumnReorgInfo(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/MockGetIndexRecordErr", `return("cantDecodeRecordErr")`))
	defer failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/MockGetIndexRecordErr")
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/MockGetIndexRecordErr"))
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/MockGetIndexRecordErr", `return("modifyColumnNotOwnerErr")`))
	tk.MustExec(sql)
	expectedElements = []*meta.Element{
...
func TestModifyColumnNullToNotNullWithChangingVal2(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockInsertValueAfterCheckNull", `return("insert into test.tt values (NULL, NULL)")`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockInsertValueAfterCheckNull"))
	}()
...
func TestModifyColumnTypeWhenInterception(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/MockReorgTimeoutInOneRegion", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/MockReorgTimeoutInOneRegion"))
	}()
