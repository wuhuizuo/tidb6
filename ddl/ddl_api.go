...
import (
	...
	field_types "github.com/wuhuizuo/tidb6/parser/types"
...
func (d *ddl) createTableWithInfoPost(
	...
	// For issue https://github.com/wuhuizuo/tidb6/issues/46093
...
func (d *ddl) AlterTable(ctx context.Context, sctx sessionctx.Context, stmt *ast.AlterTableStmt) (err error) {
	...
	for _, spec := range validSpecs {
		...
		case ast.AlterTableDisableKeys, ast.AlterTableEnableKeys:
			// Nothing to do now, see https://github.com/wuhuizuo/tidb6/issues/1051
			// MyISAM specific
...
func GetModifiableColumnJob(
	...
	newCol := table.ToColumn(&model.ColumnInfo{
		ID: col.ID,
		// We use this PR(https://github.com/wuhuizuo/tidb6/pull/6274) as the dividing line to define whether it is a new version or an old version TiDB.
