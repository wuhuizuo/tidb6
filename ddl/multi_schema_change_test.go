...
func putTheSameDDLJobTwice(t *testing.T, fn func()) {
	err := failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockParallelSameDDLJobTwice", `return(true)`)
	require.NoError(t, err)
	fn()
	err = failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockParallelSameDDLJobTwice")
	require.NoError(t, err)
}
