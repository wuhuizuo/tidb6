...
func TestCancel(t *testing.T) {
	...
	tk = testkit.NewTestKit(t, store)
	tk.MustExec("use test")
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockBackfillSlow", "return"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockBackfillSlow"))
	}()
