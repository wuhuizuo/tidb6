...
import (
	...
	"github.com/wuhuizuo/tidb6/ddl/schematracker"
	"github.com/wuhuizuo/tidb6/ddl/testutil"
...
func TestHalfwayCancelOperations(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/truncateTableErr", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/truncateTableErr"))
	}()
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/renameTableErr", `return("ty")`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/renameTableErr"))
	}()
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/exchangePartitionErr", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/exchangePartitionErr"))
	}()
...
func TestInitializeOffsetAndState(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/uninitializedOffsetAndState", `return(true)`))
	tk.MustExec("ALTER TABLE t MODIFY COLUMN b int FIRST;")
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/uninitializedOffsetAndState"))
}

func TestUpdateHandleFailed(t *testing.T) {
	s := createFailDBSuite(t)
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/errorUpdateReorgHandle", `1*return`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/errorUpdateReorgHandle"))
	}()
	tk := testkit.NewTestKit(t, s.store)
...
func TestAddIndexFailed(t *testing.T) {
	s := createFailDBSuite(t)
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockBackfillRunErr", `1*return`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockBackfillRunErr"))
	}()
	tk := testkit.NewTestKit(t, s.store)
...
func TestFailSchemaSyncer(t *testing.T) {
	...
	// make reload failed.
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/domain/ErrorMockReloadFailed", `return(true)`))
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/domain/ErrorMockReloadFailed"))
...
func TestGenGlobalIDFail(t *testing.T) {
	s := createFailDBSuite(t)
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockGenGlobalIDFail"))
	}()
	tk := testkit.NewTestKit(t, s.store)
	...
	for idx, test := range testcases {
		if test.mockErr {
			require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockGenGlobalIDFail", `return(true)`))
			_, err := tk.Exec(test.sql)
			require.Errorf(t, err, "the %dth test case '%s' fail", idx, test.sql)
		} else {
			require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockGenGlobalIDFail", `return(false)`))
...
func testAddIndexWorkerNum(t *testing.T, s *failedSuite, test func(*testkit.TestKit)) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/checkBackfillWorkerNum", `return(true)`))
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/checkBackfillWorkerNum"))
...
func TestRunDDLJobPanic(t *testing.T) {
	s := createFailDBSuite(t)
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockPanicInRunDDLJob"))
	}()
	tk := testkit.NewTestKit(t, s.store)
	tk.MustExec("use test")
	tk.MustExec("drop table if exists t")
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockPanicInRunDDLJob", `1*panic("panic test")`))
...
func TestPartitionAddIndexGC(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockUpdateCachedSafePoint", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockUpdateCachedSafePoint"))
	}()
...
func TestPartitionAddPanic(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/CheckPartitionByRangeErr", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/CheckPartitionByRangeErr"))
	}()
