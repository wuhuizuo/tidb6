...
import (
	...
	parsertypes "github.com/wuhuizuo/tidb6/parser/types"
	...
	"github.com/wuhuizuo/tidb6/util/dbterror"
...
// Close issue #24580
// See https://github.com/wuhuizuo/tidb6/issues/24580
...
// Close issue #27862 https://github.com/wuhuizuo/tidb6/issues/27862
...
// see https://github.com/wuhuizuo/tidb6/issues/24288
...
// Close issue #23321.
// See https://github.com/wuhuizuo/tidb6/issues/23321
...
func TestDropTableOnTiKVDiskFull(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/store/mockstore/unistore/rpcTiKVAllowedOnAlmostFull", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/mockstore/unistore/rpcTiKVAllowedOnAlmostFull"))
	}()
...
func TestDDLJobErrorCount(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockErrEntrySizeTooLarge", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockErrEntrySizeTooLarge"))
	}()
...
func TestAddIndexFailOnCaseWhenCanExit(t *testing.T) {
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/MockCaseWhenParseFailure", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/MockCaseWhenParseFailure"))
	}()
	store := testkit.CreateMockStoreWithSchemaLease(t, dbTestLease)
	tk := testkit.NewTestKit(t, store)
...
// Close issue #24172.
// See https://github.com/wuhuizuo/tidb6/issues/24172
func TestCancelJobWriteConflict(t *testing.T) {
	...
	hook.OnJobRunBeforeExported = func(job *model.Job) {
		if job.Type == model.ActionAddIndex && job.State == model.JobStateRunning && job.SchemaState == model.StateWriteReorganization {
			...
			require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/kv/mockCommitErrorInNewTxn", `return("no_retry")`))
			defer func() { require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/kv/mockCommitErrorInNewTxn")) }()
			require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockCancelConcurencyDDL", `return(true)`))
			defer func() { require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockCancelConcurencyDDL")) }()
	...
	hook.OnJobRunBeforeExported = func(job *model.Job) {
		if job.Type == model.ActionAddIndex && job.State == model.JobStateRunning && job.SchemaState == model.StateWriteReorganization {
			jobID = job.ID
			stmt := fmt.Sprintf("admin cancel ddl jobs %d", job.ID)
			require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/kv/mockCommitErrorInNewTxn", `return("retry_once")`))
			defer func() { require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/kv/mockCommitErrorInNewTxn")) }()
			rs, cancelErr = tk2.Session().Execute(context.Background(), stmt)
		}
	}
...
func TestTiDBDownBeforeUpdateGlobalVersion(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/mockDownBeforeUpdateGlobalVersion", `return(true)`))
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/checkDownBeforeUpdateGlobalVersion", `return(true)`))
	tk.MustExec("alter table t add column b int")
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/mockDownBeforeUpdateGlobalVersion"))
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/checkDownBeforeUpdateGlobalVersion"))
}
