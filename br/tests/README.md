...
```sh
make br_unit_test ARGS='github.com/wuhuizuo/tidb6/br/pkg/cdclog --test.v --check.v --check.f TestColumn'
#                      ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ ^~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
go test github.com/wuhuizuo/tidb6/br/pkg/cdclog --test.v --check.v --check.f TestColumn
