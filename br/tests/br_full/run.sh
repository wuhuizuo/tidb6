...
export GO_FAILPOINTS="github.com/wuhuizuo/tidb6/br/pkg/backup/reset-retryable-error=1*return(\"Unavailable\")->1*return(\"Internal\")"
...
export GO_FAILPOINTS="github.com/wuhuizuo/tidb6/br/pkg/backup/reset-not-retryable-error=1*return(true)"
...
export GO_FAILPOINTS="github.com/wuhuizuo/tidb6/br/pkg/backup/backup-storage-error=1*return(\"connection refused\")->1*return(\"InternalError\");github.com/wuhuizuo/tidb6/br/pkg/backup/backup-timeout-error=1*return(\"<Code>RequestTimeout</Code>\")->1*return(\"not read from or written to within the timeout period\")"
...
for ct in limit lz4 zstd; do
  ...
  export GO_FAILPOINTS="github.com/wuhuizuo/tidb6/br/pkg/restore/restore-storage-error=1*return(\"connection refused\");github.com/wuhuizuo/tidb6/br/pkg/restore/restore-gRPC-error=1*return(true)"
  export GO_FAILPOINTS=$GO_FAILPOINTS";github.com/wuhuizuo/tidb6/br/pkg/restore/no-leader-error=3*return(true)"
