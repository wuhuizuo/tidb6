...
export GO_FAILPOINTS="github.com/wuhuizuo/tidb6/br/pkg/lightning/EnableTestAPI=return"
export GO_FAILPOINTS="${GO_FAILPOINTS};github.com/wuhuizuo/tidb6/br/pkg/lightning/backend/local/ReadyForImportEngine=sleep(10000)"
