...
export GO_FAILPOINTS='github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/FailAfterWriteRows=panic'
...
export GO_FAILPOINTS='github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/FailAfterWriteRows=1*return->panic'
