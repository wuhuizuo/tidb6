...
GO_FAILPOINTS="github.com/wuhuizuo/tidb6/br/pkg/restore/split/not-leader-error=1*return(true)->1*return(false);\
github.com/wuhuizuo/tidb6/br/pkg/restore/split/somewhat-retryable-error=3*return(true)" \
