...
run_test() {
    ...
    # put some keys starts with t. https://github.com/wuhuizuo/tidb6/issues/35279
...
run_test "github.com/wuhuizuo/tidb6/br/pkg/backup/tikv-region-error=1*return(\"region error\")"
# all regions failed.
run_test "github.com/wuhuizuo/tidb6/br/pkg/backup/tikv-region-error=return(\"region error\")"
