...
# restore full
echo "restore start..."
export GO_FAILPOINTS="github.com/wuhuizuo/tidb6/br/pkg/restore/restore-createtables-error=return(true)"
...
# restore full
echo "restore start..."
export GO_FAILPOINTS="github.com/wuhuizuo/tidb6/br/pkg/pdutil/PDEnabledPauseConfig=return(true)"
