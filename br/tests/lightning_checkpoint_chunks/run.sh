...
TASKID_FAILPOINTS="github.com/wuhuizuo/tidb6/br/pkg/lightning/SetTaskID=return(1234567890)"
export GO_FAILPOINTS="$TASKID_FAILPOINTS;github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/FailIfImportedChunk=return"
...
export GO_FAILPOINTS="$TASKID_FAILPOINTS;github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/KillIfImportedChunk=return"
