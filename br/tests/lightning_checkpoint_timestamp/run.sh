...
export GO_FAILPOINTS="github.com/wuhuizuo/tidb6/br/pkg/lightning/SetTaskID=return(1234567890);github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/FailIfImportedChunk=return"
