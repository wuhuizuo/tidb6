...
# Data engine part
export GO_FAILPOINTS='github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/SlowDownImport=sleep(500);github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/FailIfStatusBecomes=return(120);github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/FailIfIndexEngineImported=return(140)'
