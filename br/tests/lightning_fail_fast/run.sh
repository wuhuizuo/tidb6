...
export GO_FAILPOINTS='github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/SlowDownWriteRows=sleep(100);github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/SetMinDeliverBytes=return(1)'
