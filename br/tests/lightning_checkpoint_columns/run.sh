...
PKG="github.com/wuhuizuo/tidb6/br/pkg/lightning/restore"
...
export GO_FAILPOINTS="${GO_FAILPOINTS};github.com/wuhuizuo/tidb6/br/pkg/lightning/PrintStatus=return()"
...
export GO_FAILPOINTS="github.com/wuhuizuo/tidb6/br/pkg/lightning/PrintStatus=return()"
set +e
run_lightning -d "$DBPATH" --backend tidb --enable-checkpoint=1 2> /dev/null
set -e
