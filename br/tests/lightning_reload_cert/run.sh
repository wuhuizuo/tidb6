...
export GO_FAILPOINTS="github.com/wuhuizuo/tidb6/br/pkg/lightning/SetCertExpiredSoon=return(\"$TEST_DIR/certs/ca.key\")"
export GO_FAILPOINTS="${GO_FAILPOINTS};github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/SlowDownWriteRows=sleep(15000)"
