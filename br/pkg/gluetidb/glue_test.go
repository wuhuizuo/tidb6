...
func TestSplitBatchCreateTable(t *testing.T) {
	...
	// keep/reused table id verification
	tk.Session().SetValue(sessionctx.QueryString, "skip")
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/RestoreBatchCreateTableEntryTooLarge", "return(1)"))
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/RestoreBatchCreateTableEntryTooLarge"))
}
...
func TestSplitBatchCreateTableFailWithEntryTooLarge(t *testing.T) {
	...
	tk.Session().SetValue(sessionctx.QueryString, "skip")
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/RestoreBatchCreateTableEntryTooLarge", "return(0)"))
	err := se.SplitBatchCreateTable(model.NewCIStr("test"), infos, ddl.AllocTableIDIf(func(ti *model.TableInfo) bool {
		return true
	}))
