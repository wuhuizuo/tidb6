...
import (
	...
	"github.com/wuhuizuo/tidb6/util/dbutil"
)
...
func TestConnect(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable(
		"github.com/wuhuizuo/tidb6/br/pkg/lightning/common/MustMySQLPassword",
		fmt.Sprintf("return(\"%s\")", plainPsw)))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/br/pkg/lightning/common/MustMySQLPassword"))
	}()
