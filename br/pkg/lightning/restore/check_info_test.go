...
func TestCheckTableEmpty(t *testing.T) {
	...
	err = failpoint.Enable("github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/CheckTableEmptyFailed", `return`)
	require.NoError(t, err)
	defer func() {
		_ = failpoint.Disable("github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/CheckTableEmptyFailed")
	}()
...
func TestLocalResource(t *testing.T) {
	...
	err = failpoint.Enable("github.com/wuhuizuo/tidb6/br/pkg/lightning/common/GetStorageSize", "return(2048)")
	require.NoError(t, err)
	defer func() {
		_ = failpoint.Disable("github.com/wuhuizuo/tidb6/br/pkg/lightning/common/GetStorageSize")
	}()
