...
import (
	...
	"github.com/wuhuizuo/tidb6/br/pkg/lightning/backend"
	"github.com/wuhuizuo/tidb6/br/pkg/lightning/backend/kv"
	"github.com/wuhuizuo/tidb6/br/pkg/lightning/backend/noop"
	"github.com/wuhuizuo/tidb6/br/pkg/lightning/backend/tidb"
	"github.com/wuhuizuo/tidb6/br/pkg/lightning/checkpoints"
	"github.com/wuhuizuo/tidb6/br/pkg/lightning/common"
	"github.com/wuhuizuo/tidb6/br/pkg/lightning/config"
	"github.com/wuhuizuo/tidb6/br/pkg/lightning/errormanager"
	"github.com/wuhuizuo/tidb6/br/pkg/lightning/glue"
	"github.com/wuhuizuo/tidb6/br/pkg/lightning/log"
	"github.com/wuhuizuo/tidb6/br/pkg/lightning/metric"
	"github.com/wuhuizuo/tidb6/br/pkg/lightning/mydump"
	restoremock "github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/mock"
	ropts "github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/opts"
	"github.com/wuhuizuo/tidb6/br/pkg/lightning/verification"
	"github.com/wuhuizuo/tidb6/br/pkg/lightning/web"
	"github.com/wuhuizuo/tidb6/br/pkg/lightning/worker"
	"github.com/wuhuizuo/tidb6/br/pkg/mock"
	...
	"github.com/wuhuizuo/tidb6/store/pdtypes"
	"github.com/wuhuizuo/tidb6/table/tables"
	"github.com/wuhuizuo/tidb6/types"
	tmock "github.com/wuhuizuo/tidb6/util/mock"
	"github.com/wuhuizuo/tidb6/util/promutil"
...
func (s *tableRestoreSuite) TestPopulateChunks() {
	_ = failpoint.Enable("github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/PopulateChunkTimestamp", "return(1234567897)")
	defer func() {
		_ = failpoint.Disable("github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/PopulateChunkTimestamp")
	}()
...
func (s *tableRestoreSuite) TestSaveStatusCheckpoint() {
	_ = failpoint.Enable("github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/SlowDownCheckpointUpdate", "sleep(100)")
	defer func() {
		_ = failpoint.Disable("github.com/wuhuizuo/tidb6/br/pkg/lightning/restore/SlowDownCheckpointUpdate")
	}()
