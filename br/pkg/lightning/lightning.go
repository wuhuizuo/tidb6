...
import (
	...
	"github.com/wuhuizuo/tidb6/br/pkg/lightning/restore"
	...
	_ "github.com/wuhuizuo/tidb6/expression" // get rid of `import cycle`: just init expression.RewriteAstExpr,and called at package `backend.kv`.
	_ "github.com/wuhuizuo/tidb6/planner/core"
