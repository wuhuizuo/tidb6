...
func createSuite(t *testing.T) *lightningServerSuite {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/br/pkg/lightning/SkipRunTask", "return"))
	t.Cleanup(func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/br/pkg/lightning/SkipRunTask"))
		s.lightning.Stop()
	})
