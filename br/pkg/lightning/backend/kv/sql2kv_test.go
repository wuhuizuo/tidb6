...
import (
	...
	lkv "github.com/wuhuizuo/tidb6/br/pkg/lightning/backend/kv"
...
func TestEncodeRowFormatV2(t *testing.T) {
	// Test encoding in row format v2, as described in <https://github.com/wuhuizuo/tidb6/blob/master/docs/design/2018-07-19-row-format.md>.
...
// BenchmarkSQL2KV Run `go test -benchmem -run=^$ -bench ^BenchmarkSQL2KV$ github.com/wuhuizuo/tidb6/br/pkg/lightning/backend/kv` to get benchmark result.
