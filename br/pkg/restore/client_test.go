...
import (
	...
	"github.com/wuhuizuo/tidb6/br/pkg/gluetidb"
	...
	"github.com/wuhuizuo/tidb6/br/pkg/utils/iter"
...
func TestInitFullClusterRestore(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/br/pkg/restore/mock-incr-backup-data", "return(true)"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/br/pkg/restore/mock-incr-backup-data"))
	}()
	client.InitFullClusterRestore(false)
	require.False(t, client.IsFullClusterRestore())
}
