...
func TestServerIsBusyWithMemoryIsLimited(t *testing.T) {
	_ = failpoint.Enable("github.com/wuhuizuo/tidb6/br/pkg/restore/hint-memory-is-limited", "return(true)")
	defer func() {
		_ = failpoint.Disable("github.com/wuhuizuo/tidb6/br/pkg/restore/hint-memory-is-limited")
	}()
