...
import (
	...
	"github.com/wuhuizuo/tidb6/br/pkg/checkpoint"
	"github.com/wuhuizuo/tidb6/br/pkg/conn"
	connutil "github.com/wuhuizuo/tidb6/br/pkg/conn/util"
...
func BuildBackupRangeAndSchema(
	...
	if isFullBackup {
		// according to https://github.com/wuhuizuo/tidb6/issues/32290
		...
		for _, tableInfo := range tables {
			...
			default:
				if tableInfo.SepAutoInc() {
					...
					// See also https://github.com/wuhuizuo/tidb6/issues/46093
...
func isRetryableError(err error) bool {
	...
	// https://github.com/wuhuizuo/tidb6/issues/34350
