...
func TestRetryError(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/br/pkg/storage/replace-error-to-connection-reset-by-peer", "return(true)"))
	defer func() {
		failpoint.Disable("github.com/wuhuizuo/tidb6/br/pkg/storage/replace-error-to-connection-reset-by-peer")
	}()
