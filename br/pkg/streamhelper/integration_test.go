...
func testStreamClose(t *testing.T, metaCli streamhelper.AdvancerExt) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/br/pkg/streamhelper/advancer_close_channel", "return"))
	defer failpoint.Disable("github.com/wuhuizuo/tidb6/br/pkg/streamhelper/advancer_close_channel")
