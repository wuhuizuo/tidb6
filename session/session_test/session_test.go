...
import (
	...
	"github.com/wuhuizuo/tidb6/parser/format"
...
func TestDoDDLJobQuit(t *testing.T) {
	...
	// test https://github.com/wuhuizuo/tidb6/issues/18714, imitate DM's use environment
	...
	require.Nil(t, failpoint.Enable("github.com/wuhuizuo/tidb6/ddl/storeCloseInLoop", `return`))
	defer func() { require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/ddl/storeCloseInLoop")) }()
...
func TestCoprocessorOOMAction(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/store/copr/testRateLimitActionMockConsumeAndAssert", `return(true)`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/copr/testRateLimitActionMockConsumeAndAssert"))
	}()
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/store/copr/testRateLimitActionMockWaitMax", `return(true)`))
	...
	require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/store/copr/testRateLimitActionMockWaitMax"))
...
// Testcase for https://github.com/wuhuizuo/tidb6/issues/325
...
func TestParser(t *testing.T) {
	...
	// test for https://github.com/wuhuizuo/tidb6/pull/177
...
func TestOnDuplicate(t *testing.T) {
	...
	// test for https://github.com/wuhuizuo/tidb6/pull/454
	tk.MustExec("drop table if exists t")
	tk.MustExec("drop table if exists t1")
...
func TestReplace(t *testing.T) {
	...
	// test for https://github.com/wuhuizuo/tidb6/pull/456
	tk.MustExec("drop table if exists t")
	tk.MustExec("drop table if exists t1")
	tk.MustExec("create table t1 (c1 int, c2 int, c3 int);")
...
func TestDelete(t *testing.T) {
	// test for https://github.com/wuhuizuo/tidb6/pull/1135
...
// test for https://github.com/wuhuizuo/tidb6/pull/461
func TestUnique(t *testing.T) {
	...
	// Test for https://github.com/wuhuizuo/tidb6/issues/463
...
// Test for https://github.com/wuhuizuo/tidb6/issues/1114
...
func TestCast(t *testing.T) {
	...
	// test for issue: https://github.com/wuhuizuo/tidb6/issues/34539
...
func TestUpgradeSysvars(t *testing.T) {
	...
	// This further helps for https://github.com/wuhuizuo/tidb6/pull/28842
