...
// TypeContext is the template context for each "github.com/wuhuizuo/tidb6/types".EvalType .
type TypeContext struct {
	// Describe the name of "github.com/wuhuizuo/tidb6/types".ET{{ .ETName }} .
	ETName string
	// Describe the name of "github.com/wuhuizuo/tidb6/expression".VecExpr.VecEval{{ .TypeName }} .
	TypeName string
	// Describe the name of "github.com/wuhuizuo/tidb6/util/chunk".*Column.Append{{ .TypeNameInColumn }},
	...
	TypeNameGo string
	// Same as "github.com/wuhuizuo/tidb6/util/chunk".getFixedLen() .
	Fixed bool
}
