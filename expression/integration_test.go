...
func TestAggregationBuiltinJSONObjectAgg(t *testing.T) {
	...
	// For issue: https://github.com/wuhuizuo/tidb6/issues/39806
...
func TestTiDBDecodeKeyFunc(t *testing.T) {
	...
	// https://github.com/wuhuizuo/tidb6/issues/27434.
	hexKey = "7480000000000100375F69800000000000000103800000000001D4C1023B6458"
	sql = fmt.Sprintf("select tidb_decode_key('%s')", hexKey)
	tk.MustQuery(sql).Check(testkit.Rows(hexKey))

	// https://github.com/wuhuizuo/tidb6/issues/33015.
...
func TestIssue11309And11319(t *testing.T) {
	...
	// for https://github.com/wuhuizuo/tidb6/issues/11319
...
// https://github.com/wuhuizuo/tidb6/issues/34500.
...
func TestIssue10467(t *testing.T) {
	...
	// See: https://github.com/wuhuizuo/tidb6/issues/9988
...
// See: https://github.com/wuhuizuo/tidb6/issues/24368
...
// issue https://github.com/wuhuizuo/tidb6/issues/28544
...
// issue https://github.com/wuhuizuo/tidb6/issues/26111
...
func TestAesDecryptionVecEvalWithZeroChunk(t *testing.T) {
	// see issue: https://github.com/wuhuizuo/tidb6/issues/43063
	store := testkit.CreateMockStore(t)
	tk := testkit.NewTestKit(t, store)
	tk.MustExec("use test")
