...
func TestMetadata(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/expression/PushDownTestSwitcher", `return("all")`))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/expression/PushDownTestSwitcher"))
	}()
...
func TestPushDownSwitcher(t *testing.T) {
	...
	// All disabled
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/expression/PushDownTestSwitcher", `return("")`))
	pc := PbConverter{client: client, sc: sc}
	for i := range funcs {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/expression/PushDownTestSwitcher", fpexpr))
	for i := range funcs {
		pbExpr := pc.ExprToPB(funcs[i])
		if !cases[i].enable {
			require.Nil(t, pbExpr)
...
func TestPanicIfPbCodeUnspecified(t *testing.T) {
	...
	require.NoError(t, failpoint.Enable("github.com/wuhuizuo/tidb6/expression/PanicIfPbCodeUnspecified", "return(true)"))
	defer func() {
		require.NoError(t, failpoint.Disable("github.com/wuhuizuo/tidb6/expression/PanicIfPbCodeUnspecified"))
	}()
